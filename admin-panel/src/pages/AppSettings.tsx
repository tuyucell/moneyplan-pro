            ...
            <Alert
                description={
                    <Flex vertical gap={4}>
                        ...
                        <Text type="secondary">Buradaki değişiklikler backend önbelleği yenilendiğinde (yaklaşık 1-5 dk) tüm kullanıcılara yansır. API anahtarlarını güncellerken dikkatli olun.</Text>
                    </Flex>
                }
                type="info"
                showIcon
