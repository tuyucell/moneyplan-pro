...
export default function UserProfileIntelligence() {
    ...
    const logColumns: ColumnsType<any> = [
        ...
        { title: 'Record ID', dataIndex: 'record_id', key: 'rid', render: (id) => <Text type="secondary" style={{ fontSize: '11px' }}>{id}</Text> },
    ];
                        ...
                        <Row gutter={24} align="middle">
                            ...
                            <Col flex="auto">
                                <Descriptions column={3}>
                                    ...
                                    <Descriptions.Item label="Name">{user.display_name || 'Anonymous'}</Descriptions.Item>
                                    ...
                                    <Descriptions.Item label="User ID"><Text copyable style={{ fontSize: '12px' }}>{user.id}</Text></Descriptions.Item>
                                </Descriptions>
                            </Col>
                        </Row>
                    </Card>
