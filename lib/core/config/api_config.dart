...
class ApiConfig {
  ...
  static const String bistApiKey =
      ''; // To be filled if institutional access is granted

  /// Alternative: RapidAPI - BIST100 Stock Data (15 minutes delayed)
  /// Free tier available with rate limits
  static const String rapidApiBistUrl =
      'https://bist100-stock-data-15-minutes-late-live.p.rapidapi.com';
  static const String rapidApiKey =
      ''; // To be filled - Get from: https://rapidapi.com
  ...
  static const String twelveDataApiKey =
      ''; // To be filled - Get from: https://twelvedata.com
  ...
  static const String tcmbApiKey =
      ''; // To be filled - Get from: https://evds2.tcmb.gov.tr
  ...
  /// Never replace unavailable financial data with fabricated samples.
