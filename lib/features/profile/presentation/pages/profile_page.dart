...
import 'package:invest_guide/features/subscription/presentation/pages/subscription_page.dart';
            ...
            _buildSettingsTile(
              ...
              onTap: () {
                url_launcher.launchUrl(
                    Uri.parse('https://moneyplanpro.app/refund.html'));
              },
            ),
            _buildSettingsTile(
              context,
              ...
              onTap: () {
                url_launcher.launchUrl(
                    Uri.parse('https://moneyplanpro.app/privacy.html'));
              },
            ),
            GestureDetector(
              onLongPress: () {
                const adminEmail = 'turgay@investguide.app';
              ...
              child: _buildSettingsTile(
                ...
                onTap: () {
                  url_launcher.launchUrl(
                      Uri.parse('https://moneyplanpro.app/terms.html'));
                },
              ),
            ),
