...
class _MarketsPageState extends ConsumerState<MarketsPage> {
        ...
        content: Column(
          ...
          children: [
            FutureBuilder<Map<String, dynamic>>(
              future: MoneyPlanProApi.getExternalHealth(),
              builder: (context, snapshot) {
                ...
                if (health == null || health.isEmpty) {
                  return Text(
                    lc == 'tr'
                        ? 'Backend sunucusuna ulaşılamadı veya hata oluştu.'
                        : 'Backend server is unreachable or an error occurred.',
  ...
  Widget _buildHealthRow(String label, dynamic status) {
    final isOk = status.toString().startsWith('ok');
    return Padding(
