...
import 'package:moneyplan_pro/features/shared/widgets/enhanced_market_item_card.dart';
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      switch (widget.categoryId) {
        case 'crypto':
          final data = await MoneyPlanProApi.getCryptoMarkets(limit: 50);
        ...
        case 'stock':
          final data = await MoneyPlanProApi.getStocks();
        ...
        case 'commodity':
          final data = await MoneyPlanProApi.getCommodities();
        ...
        case 'etf':
          final data = await MoneyPlanProApi.getETFs();
        ...
        case 'bond':
          final data = await MoneyPlanProApi.getBonds();
