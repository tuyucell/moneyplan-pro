...
import 'package:moneyplan_pro/features/search/presentation/widgets/animated_search_hint.dart';
  ...
  Future<void> _performSearch(String query) async {
    ...
    try {
      final results = await Future.wait([
        MoneyPlanProApi.getStocks(),
        MoneyPlanProApi.getCryptoMarkets(limit: 100),
        MoneyPlanProApi.getCurrencies(),
        MoneyPlanProApi.getCommodities(),
      ]);
